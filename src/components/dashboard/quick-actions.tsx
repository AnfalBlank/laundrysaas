...
const actions = [
  { label: "Order Baru", desc: "Input cepat", icon: <WashingMachine3D className="w-8 h-8 sm:w-9 sm:h-9" /> },
  { label: "Pickup", desc: "Jadwal jemput", icon: <TruckDelivery3D className="w-8 h-8 sm:w-9 sm:h-9" /> },
  { label: "Broadcast", desc: "WhatsApp", icon: <Whatsapp3D className="w-8 h-8 sm:w-9 sm:h-9" /> },
  { label: "Scan QR", desc: "Update status", icon: <QRCode3D className="w-8 h-8 sm:w-9 sm:h-9" /> },
  { label: "Invoice", desc: "Cetak thermal", icon: <Receipt3D className="w-8 h-8 sm:w-9 sm:h-9" /> },
  { label: "AI Assist", desc: "Saran promo", icon: <Sparkles3D className="w-8 h-8 sm:w-9 sm:h-9" /> },
];
